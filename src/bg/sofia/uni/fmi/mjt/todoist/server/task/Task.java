...
public class Task implements Serializable {
    ...
    public Task(String name, LocalDate date, LocalDate dueDate, String description) {
        if (name == null) {
            throw new IllegalArgumentException("Cannot create a task with no name");
        }
    ...
    public void markAsFinished() throws TaskAlreadyFinishedException {
        if (this.isFinished) {
            throw new TaskAlreadyFinishedException("Cannot mark a task as finished when it is already finished");
        }
    ...
    public String toString() {
        return "Task: " + this.name +
            ", Date: " + getStringData(this.date) +
            ", Due: " + getStringData(this.dueDate) +
            ", Description: " + getStringData(this.description) +
